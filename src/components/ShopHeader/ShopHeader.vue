...
<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <!-- 回退按钮 -->
      <a class="back" @click="$router.replace({path:'/msite'})">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="infoShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShowInfo">
...
export default {
  data () {
    return {    
        supportClasses: ['activity-green', 'activity-red', 'activity-orange'],   //三个颜色类名
        infoShow:false,      //是否显示商家详情
        supportShow:false,   //是否显示优惠详情
    };
  },
